...
from toughflac import zonearray as tza
...
python_func_flac = (write_ascii)  # After mechanical analysis
...
def write_porosity_ascii(tough_time):
    ...
    ## ASCII
    with open('fla_tou_'+str(tttough)+'_'+str(tstep), 'wb') as f:
        numpy.savetxt(f,za.extra['phi'],fmt="%1.5e",delimiter=",")

    with open('fla_tou2', 'wb') as f:
        numpy.savetxt(f,tza.porosity(),fmt="%1.5e",delimiter=",")
