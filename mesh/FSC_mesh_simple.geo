...
Extrude {0,0, 0.5} {   
  Surface{19, 11, 4}; Layers{1}; Recombine;
}

Extrude {0,0, -0.5} {   
  Surface{6,12,20}; Layers{1}; Recombine; 
}
...
Field[1] = Distance;
Field[1].SurfacesList = {8, 9, 10, 11, 12, 13, 3};
...
// ---- your distance field near the fault faces
Field[3] = Distance;
Field[3].SurfacesList = {15,16,23,24,25};
...
Physical Volume("INJEC") = {4,5};
Physical Volume("BNDTO") = {6,7,8};
Physical Volume("BNDBO") = {9,10,11};
